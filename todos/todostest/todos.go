...
// Todos is an autogenerated mock type for the Todos type
type Todos struct {
	mock.Mock
}

// Clear provides a mock function with given fields: ctx
func (_m *Todos) Clear(ctx context.Context) {
	_m.Called(ctx)
}

// Create provides a mock function with given fields: ctx, todo
func (_m *Todos) Create(ctx context.Context, todo *todos.Todo) error {
...
func (_m *Todos) Delete(ctx context.Context, todo *todos.Todo) {
	_m.Called(ctx, todo)
}

// Search provides a mock function with given fields: ctx, _a1, filter
func (_m *Todos) Search(ctx context.Context, _a1 *[]todos.Todo, filter todos.Filter) error {
...
func (_m *Todos) Update(ctx context.Context, todo *todos.Todo, changes rel.Changeset) error {
